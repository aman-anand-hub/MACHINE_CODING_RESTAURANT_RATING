...
public class Configuration {
            ...
            private final IReviewRepository reviewRepository= new ReviewRepository(userRepository, restaurantRepository);
            ...
            private void registerCommands(){
                ...
                commandRegistry.registerCommand(CommandKeyword.LIST_RESTAURANTS_COMMAND.getName(),listRestaurantsCommand);

                commandRegistry.registerCommand(CommandKeyword.ADD_RATING_COMMANND.getName(),addRatingCommand);
